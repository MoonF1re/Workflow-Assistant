...
- Если значение не указано — поставь `null`.
...
Примеры:
Пользователь: "поставь таймер на 5 минут"
Ожидаемые слоты: [{{"name": "minutes", "type": "int"}}]
Ответ: {{"minutes": 5}}

Теперь проанализируй команду выше и выдай JSON с заполненными слотами.
