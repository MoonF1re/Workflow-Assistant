...
# Популярные filler-слова, которые обычно можно убрать
_DEFAULT_FILLERS = {
    "эм", "ээ", "эээ", "мм", "ммм", "ну", "короче", "как бы", "то есть", "типа", "в общем",
    "ладно", "вот", "же"
}
...
# Попытка импортировать pymorphy2 для лемматизации — если нет, просто пропустим
